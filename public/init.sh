...
git subtree add --prefix=public git@github.com:guzzlerio/corcel.io.git gh-pages --squash

# Pull down the file we just committed. This helps avoid merge conflicts
git subtree pull --prefix=public git@github.com:guzzlerio/corcel.io.git gh-pages
